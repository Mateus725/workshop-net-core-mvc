    ...
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            else
            {
                ...
                Seller s1 = new Seller(1, "Bob Esponja", "bobesponja@yahoo.com", new DateTime(1998, 3, 20), 998.0, d3);
                Seller s2 = new Seller(2, "Claudinho", "craudinho@gmail.com", new DateTime(1994, 8, 14), 1100.0, d4);
                Seller s3 = new Seller(3, "Fernanda", "fernandinha@msn.com", new DateTime(2001, 1, 27), 1300.0, d2);
                Seller s4 = new Seller(4, "Keanu", "jonhwick@outlook.com", new DateTime(1990, 5, 24), 1500.0, d1);
                ...
                SalesRecord r1 = new SalesRecord(1, new DateTime(2019, 6, 30), 11000.0, SaleStatus.Billed, s4);
                SalesRecord r2 = new SalesRecord(2, new DateTime(2019, 2, 14), 1000.0, SaleStatus.Canceled, s1);
                SalesRecord r3 = new SalesRecord(3, new DateTime(2019, 5, 26), 9000.0, SaleStatus.Billed, s3);
                SalesRecord r4 = new SalesRecord(4, new DateTime(2019, 3, 2), 7000.0, SaleStatus.Pending, s2);
